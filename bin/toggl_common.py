...
def fetch_projects_with_clients(api_token: str) -> tuple[Dict[str, str], Dict[str, str]]:
    """
...
def get_time_entries(api_token: str, start_date: date, end_date: Optional[date] = None) -> List[Dict]:
    """
